...
java -jar google-java-format-1.5-all-deps.jar -r src/main/java/com/npcss/npcss/*
java -jar google-java-format-1.5-all-deps.jar -r src/main/java/com/npcss/npcss/commands/*
java -jar google-java-format-1.5-all-deps.jar -r src/main/java/com/npcss/npcss/events/*
exit /b 0
